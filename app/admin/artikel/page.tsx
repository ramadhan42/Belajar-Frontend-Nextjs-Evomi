...
export default function ArticlesMenu() {
  ...
  const executeDelete = async () => {
    ...
    try {
      const res = await fetch(`${API_URL}/${deleteModal.articleId}`, {
        method: "DELETE",
      });
      if (res.ok) {
        fetchArticles();
      ...
      {successModal.isOpen && (
        <div className="fixed bottom-10 right-10 z-[100] animate-in fade-in slide-in-from-bottom-5 duration-300">
          <div className="bg-white border border-gray-100 shadow-[0_10px_40px_rgba(0,0,0,0.08)] rounded-2xl p-4 flex items-center gap-4 min-w-[320px] backdrop-blur-lg bg-white/90">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center ${successModal.type === "delete" ? "bg-red-50 text-red-500" : "bg-green-50 text-green-500"}`}
            >
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl border border-gray-100 overflow-hidden transform scale-100 transition-all">
            <div className="p-6 text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Ingin Menghapus Artikel Ini, Artikel Akan Terhapus Dari List dan
                Database.
              </p>
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Kelola cerita, panduan, dan pembaruan brand untuk pelanggan.
            </p>
          </div>
          <button
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                {isLoading ? (
                  ...
                  currentItems.map((article) => (
                    ...
                    >
                      <td className="px-0 py-2 md:px-6 md:py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="overflow-hidden">
                            <div className="text-sm font-bold text-gray-900 truncate max-w-[200px] md:max-w-xs">
                              {article.title}
                            </div>
                      ...
                      <td className="px-0 py-2 md:px-6 md:py-4">
                        <span className="md:hidden text-[9px] font-bold text-gray-400 uppercase mb-1 block">
                          Penulis
                        </span>
                      ...
                      <td className="px-0 py-4 md:px-6 md:py-4 border-t md:border-t-0 mt-2 md:mt-0 pt-4 md:pt-4">
                        <div className="flex items-center justify-end gap-4 md:gap-3">
                          <button
                            ...
                            className="text-indigo-600 hover:text-indigo-800 text-xs font-bold transition-all"
                          >
                            Edit
                          </button>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
            <div className="text-xs text-gray-500 font-medium">
              ...
              -{" "}
              <span className="text-black font-bold">
                {Math.min(indexOfLastItem, articles.length)}
              </span>{" "}
              dari{" "}
              <span className="text-black font-bold">{articles.length}</span>{" "}
              artikel
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                <span className="text-xs font-bold px-3 py-1 bg-black text-white rounded-md">
                  {currentPage}
                </span>
              ...
              >
                <div className="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-white sticky top-0 z-10">
                  <h2 className="text-xl font-bold">
                    {editingId ? "Edit Artikel" : "Tulis Cerita Baru"}
                  </h2>
                  <button
                    type="button"
                  ...
                  <div className="space-y-4 md:col-span-1">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 bg-gray-50 border rounded-xl text-sm outline-none focus:border-black font-mono text-gray-600"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="text-xs file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-black file:text-white hover:file:bg-gray-800 w-full"
                      />
                    </div>
                  </div>
                ...
                <div className="px-8 py-6 bg-gray-50 flex justify-end gap-3 sticky bottom-0 z-10 border-t border-gray-100">
                  ...
                  <button
                    type="submit"
                    className="px-8 py-2 bg-black text-white rounded-xl text-sm font-bold hover:shadow-lg transition-all"
                  >
